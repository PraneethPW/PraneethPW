...
Kalasalingam University (2022–2026)  

### **💡 Passion & Expertise**  
🔥 **Backend Development** – Java, Spring Boot, Microservices  
⚡ **Problem Solving** – DSA, System Design  
🧬 **Biotech + Tech Fusion** – Exploring computational biology & bioinformatics  
🚀 **Building Scalable Systems** – Currently mastering Spring ecosystem  
...
🐱 **GitHub**: [Your GitHub Profile] *(Add if you have one!)*  
